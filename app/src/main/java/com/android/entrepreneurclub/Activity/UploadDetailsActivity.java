...
public class UploadDetailsActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (i.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (!TextUtils.isEmpty(report)) {
                        ...
                        if (imageFile != null) {
                            Uri imageUri = FileProvider.getUriForFile(UploadDetailsActivity.this, "com.android.entrepreneurclub.fileprovider", imageFile);
    ...
    public void uploadImage(Uri imageUri) {
        ...
        final DatabaseReference dbrefReports = FirebaseDatabase.getInstance().getReference("EntrepreneurDetails");
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                dbrefReports.child(patId).push().setValue(imageDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Toast.makeText(UploadDetailsActivity.this, "Details Uploaded Successfully !!", Toast.LENGTH_SHORT).show();
                    }
                });
